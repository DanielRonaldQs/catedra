...
<section class="banner-w3ls">
		...
		<div class="container">
			...
			<nav class="navbar navbar-inverse navbar-static-top">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="http://www.catedratesis.com.pe"><h1><img src="images/logo.png" alt="tesis huancayo" style="width:50px;" >Cátedra Tesis</h1></a>
	...
	<div style="width: 100%; text-align: center;" >	
			...
			<video src="images/video_catedra.mp4" autoplay muted loop width="100%">	</video>
	...
	<div class="container-fluid">
		<div class="col-lg-6 col-md-6 col-sm-6 about-agile1 slideanim">
			<div class="hover01 column">
				<div>
					<figure><img src="images/banner1.jpg" alt="w3layouts" class="img-responsive"></figure>
				</div>
			</div>
		</div>
	...
	<div class="container" style="text-align: center;">
		...
		<div class="col-lg-2 col-md-2 col-sm-6 team-w3l">
			<div class="team-info">
				<div class=" " >
					<div>
						<figure style="border-radius:5%"><img src="images/jesus_mantari.jpg" alt="w3layouts" class="img-responsive"></figure>
					</div>
				</div>
		...
		<div class="col-lg-2 col-md-2 col-sm-6 team-w3l">
			<div class="team-info">
				<div class=" column ">
					<div>
						<figure style="border-radius:5%"><img src="images/geancarlo.jpg" alt="w3layouts" class="img-responsive"></figure>
					</div>
				</div>
		...
		<div class="col-lg-2 col-md-2 col-sm-6 team-w3l">
			<div class="team-info">
				<div class=" column slideanim">
					<div>
					    <figure style="border-radius:5%"><img src="images/michael.jpg" alt="w3layouts" class="img-responsive"></figure>
		...
		<div class="col-lg-2 col-md-2 col-sm-6 team-w3l">
			<div class="team-info">
				<div class=" column slideanim">
					<div>
						<figure style="border-radius:5%"><img src="images/paulpalacios.jpg" alt="w3layouts" class="img-responsive"></figure>
					</div>
				</div>
		...
		<div class="col-lg-2 col-md-2 col-sm-6 team-w3l">
			<div class="team-info">
				<div class=" column slideanim">
					<div>
						<figure style="border-radius:5%"><img src="images/mayte.jpg" alt="w3layouts" class="img-responsive"></figure>
					</div>
				</div>
		...
		<div class="col-lg-2 col-md-2 col-sm-6 team-w3l">
			<div class="team-info">
				<div class="column slideanim">
					<div>
						<figure style="border-radius:5%"><img src="images/jorge_molina.jpg" alt="w3layouts" class="img-responsive"></figure>
					</div>
				</div>
				<h4 class="slideanim">Jorge Molina</h4>
				<p class="slideanim">Tecnología</p>	
				<!--<ul class="social-icons1">
						...
						<div class="gallery-link">
							...
							<div class="hidden person-info-wrap">
								<ul class="person-info">
									<li class="filter-full_name" style="color: black">Elaboración de tesis</li>
									<li><p style="text-align:justify;">La elaboración es de manera integral y personalizada, donde trabajamos las áreas técnicas, metodológicas e incluso la oratoria para que tengas una presentación y sustentación exitosa, respetando los estándares y formatos requeridos por el reglamento de tú universidad. Donde la redacción de la investigación es por parte del asesor de Cátedra Tesis.</p></li><br>
									<li><p>	&raquo;  La elaboración de la tesis es desde la elección del tema hasta la sustentación (Matriz de consistencia, planteamiento del problema, determinación de las variables, análisis estadístico)</p></li>
									<li><p>	&raquo;  El tema de investigación puede ser propuesto por el asesorado o asesor.</p></li>
									<li><p>	&raquo;  Delimitamos el tema de investigación.</p></li>
									<li><p>	&raquo;  Subsanación de observaciones, por parte de la universidad.</p></li>
									<li><p>	&raquo;  La elaboración es hasta la obtención del grado académico.</p></li>
									<li><p>	&raquo;  La investigación pasa por Turnitin para garantizar la originalidad.</p></li>
									<li><p>	&raquo;  Entrega de PPTS para la sustentación.</p></li><br>
									<li><p style="text-align:justify; ">Incluye 8 sesiones de clases en metodología de investigación y estadística.</p></li>
									<li><p style="text-align:justify; ">Tiempo de entrega promedio 3 meses (Depende del tema a investigar)</p></li>
								</ul>
							</div>
							<h4 class="slideanim">Elaboraci&oacute;n de tesis</h4>
						</div>
				...
				<ul class="gallery-wrap list">
					<li class="gallery-item slideanim" class="ch-info">
						<div class="gallery-link">
							...
							<div class="hidden person-info-wrap">
								<ul class="person-info">
									<li class="filter-full_name" style="color: black"><strong>Asesor&iacute;a de Tesis</strong></li>
									<li><p style="text-align:justify; ">La asesoría es de manera integral y personalizada, donde trabajamos las áreas técnicas, metodológicas e incluso la oratoria para que tengas una presentación y sustentación exitosa. Donde la redacción de la investigación es por parte del asesorado con nuestras sugerencias, observaciones y correcciones.</p></li><br>
									<li><p>	&raquo;  El asesoramiento de la tesis es desde la elección del tema hasta la sustentación (Matriz de consistencia, planteamiento del problema, determinación de las variables, análisis estadístico)</p></li>
									<li><p>	&raquo;  Orientamos a delimitar el tema de investigación.</p></li>
									<li><p>	&raquo;  La asesoría es hasta la obtención del grado académico.</p></li>
									<li><p>	&raquo;  La investigación pasa por Turnitin para garantizar la originalidad.</p></li><br>
									<li><p style="text-align:justify; ">Incluye 8 sesiones de clases en metodología de investigación y estadística.</p></li>
									<li><p style="text-align:justify; ">Tiempo promedio 3 meses ( 1 mes Proyecto de tesis) (2 meses Informe final de tesis o borrador de tesis)</p></li>
								</ul>
							</div>
							<h4 class="slideanim">Asesor&iacute;a de tesis</h4>
						</div>
				...
				<ul class="gallery-wrap list">
					<li class="gallery-item slideanim" class="ch-info">
						<div class="gallery-link">
							...
							<div class="hidden person-info-wrap">
								<ul class="person-info">
									<li class="filter-full_name" style="color: black">Reducci&oacute;n de similitud</li><br>
									<li><p style="text-align:justify; ">La reducción de similitud propone que tu investigación no sea igual a otra ya publicada el cual garantiza una investigación autentica.</p></li><br>
									<li><p>	&raquo;  La investigación es procesada por el software Turnitin (detectamos el grado de plagio)</p></li>
									<li><p>	&raquo;  Reducción de similitud (Plagio, copia o cita indebida)</p></li>
									<li><p>	&raquo;  Parafraseo de la investigación.</p></li>
									<li><p>	&raquo;  Tiempo promedio de 4 a 7 días.</p></li><br>
								</ul>
							</div>
							<h4 class="slideanim">Reducci&oacute;n de similitud</h4>
						</div>
				...
				<ul class="gallery-wrap list">
					<li class="gallery-item slideanim" class="ch-info">
						<div class="gallery-link">
							...
							<div class="hidden person-info-wrap">
								<ul class="person-info">
									<li class="filter-full_name" style="color: black">Tratamiento Estad&iacute;stico</li>
									<li><p style="text-align:justify; ">Una correcta aplicación de estadística descriptiva e inferencial en los datos de tu tesis o investigación, dan fidelidad y corroboran altamente la veracidad y aprobación en la presentación de tu documento presentado. En Cátedra contamos con profesionales que manejan y procesan tus datos estadísticos de la forma correcta, y se realizen adecuadamente las pruebas que son necesarias.</p></li><br>
									<li><p>	&raquo;  Procesamos tus datos para llegar a un análisis estadístico.</p></li><br>
								</ul>
							</div>
							<h4 class="slideanim">Tratamiento Estad&iacute;stico</h4>
						</div>
				...
				<ul class="gallery-wrap list">
					<li class="gallery-item slideanim" class="ch-info">
						<div class="gallery-link">
							...
							<div class="hidden person-info-wrap">
								<ul class="person-info">
									<li class="filter-full_name" style="color: black">Correci&oacute;n de estilo</li>
									<li><p style="text-align:justify; ">Corregimos el formato de tu investigación al estilo que tu universidad exige.</p></li>
									<li><p style="text-align:justify; ">Estilos (APA, VANCOUVER, ISO 690, AMA, MLA, ETC)Incluye:</p></li><br>
									<li><p>	&raquo;  Referencia bibliográfica</p></li>
									<li><p>	&raquo;  Formato de indice</p></li>
									<li><p>	&raquo;  Tipo logia de letra </p></li>
									<li><p>	&raquo;  Espaciado</p></li>
									<li><p>	&raquo;  Margenes</p></li>
									<li><p>	&raquo;  Ordenes de títulos</p></li>
									<li><p>	&raquo;  Tablas y gráficos</p></li><br>
									<li><p style="text-align:justify; ">Tiempo promedio de entrega de 10 a 15 días.</p></li>
								</ul>
							</div>
							<h4 class="slideanim">Correci&oacute;n de estilo</h4>
						</div>
...
<section class="portfolio-agileinfo jarallax" id="noticias">
	<div class="container">
        <h3 class="text-center slideanim" style="color:#b32821;">NUESTRAS PUBLICACIONES</h3>
        <?php $query2=mysqli_query($connection, "SELECT * FROM publicacion WHERE publicacionEstado='ACTIVO' ORDER BY publicacionFecha DESC LIMIT 9");
        	$i=0;
					...
					?>
			            <div class="col-lg-4 col-md-4 col-sm-4 team-w3l" >
			                <div class="team-info" style="background-color: rgba(10,10,10,0.8);">
			                	<h4 style="text-align: center;"><strong><a href="publicacion-detalle.php?publicacionId=<?php echo $idPublicacion; ?>" style="color: white;"><?php echo $titulo2; ?></a></strong></h4><br>
