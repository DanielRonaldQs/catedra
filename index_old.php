	...
	<div class="pogoSlider" id="js-main-slider">
		...
		<div class="pogoSlider-slide" data-transition="barRevealDown" data-duration="1000"  style="background-image:url(<?php echo $image ?>);">
			<div class="pogoSlider-slide-element" style="">
				<a href="publicacion-detalle.php?publicacionId=<?php echo $rowPublicacion['publicacionId'] ?>"><h3><?php echo $titulo; ?></h3></a>
			</div>
		</div>
		<?php    
		}
...
<section class="portfolio-agileinfo jarallax" id="noticias">
	<div class="container">
        ...
        <?php $query2=mysqli_query($connection, "SELECT * FROM tesispublicacion WHERE publicacionEstado='ACTIVO' ORDER BY publicacionFecha DESC LIMIT 9");
        	$i=0;
